    ...
    <div className='p-6'>
        {selectedProduct && (
         <div className='max-w-6xl mx-auto bg-white p-8 rounded-lg'>
                  ...
                  <div className='md:hidden flex overscroll-x-scroll space-x-4 mb-4'>
                   ...
                   <div className="md:w-1/2 md:ml-10">
                       ...
                       <div className='mb-6'>
                        ...
                        <button className={`bg-black text-white px-6 py-2 rounded w-full mb-4 ${isButtonDisabled ? 'cursor-not-allowed opacity-50' : 'hover:bg-gray-700'}`} 
               ...
               <div className='mt-20'>
                  <h2 className='text-center text-2xl font-semibold mb-4'>You May Also Like</h2>
