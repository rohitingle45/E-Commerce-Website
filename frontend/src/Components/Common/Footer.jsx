         ...
         <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
            ...
            <div>
                ...
                <ul className='space-y-2 text-gray-600' >
                    <li>
                        <Link to='/collections/all?category=Top+Wear&gender=Men' className='hover:text-gray-500 transition-colors hover:underline'>
                         Men's Top Wear
                        </Link>
                    </li>
                    <li>
                        <Link to='/collections/all?category=Top+Wear&gender=Women' className='hover:text-gray-500 transition-colors hover:underline'>
                         Women's Top Wear
                        </Link>
                    </li>
                    <li>
                        <Link to='/collections/all?category=Bottom+Wear&gender=Men' className='hover:text-gray-500 transition-colors hover:underline'>
                         Men's Bottom Wear
                        </Link>
                    </li>
                    <li>
                        <Link to='/collections/all?category=Bottom+Wear&gender=Women' className='hover:text-gray-500 transition-colors hover:underline'>
                         Women's Bottom Wear
                        </Link>
                    </li>
                </ul>
