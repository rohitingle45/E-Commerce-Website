            ...
            {orders && orders.length > 0 ? (
              orders.map((order) => (
                ...
                >
                  ...
                  <td className="py-2 px-2 sm:py-4 sm:px-4 text-gray-800 font-medium whitespace-nowrap">
                    #{order._id}
                  </td>
                  ...
                  <td className="py-2 px-2 sm:py-4 sm:px-4">
                    <span
                      className={`px-2 py-1 rounded-full font-medium text-xs sm:text-sm ${
              ...
              <tr>
                <td
                  colSpan={7}
                  className="py-4 px-4 text-center text-gray-800 font-medium"
                >
                  You have no orders
                </td>
              </tr>
