...
const OrderDetailsPage = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto p-4 sm:p-6'>
        ...
        {!orderDetails ? (
            <p className='text-gray-400 text-lg'>No Order Details Found</p>
        )
        :(
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8'>
                    <div>
                     ...
                     <div>
                        ...
                        <p>Shipping Address: {`${orderDetails.shippingAddress.address} , ${orderDetails.shippingAddress.city} , ${orderDetails.shippingAddress.country}`}</p>
                    </div>
                </div>
                {/* Product List */}
